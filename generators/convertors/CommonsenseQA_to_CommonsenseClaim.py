"""
Converter script for CommonsenseQA dataset to CommonsenseClaim dataset.
"""
...
print("Generating TRUE claims (correct answers)...")
...
print("Generating FALSE claims (random wrong answers)...")
...
print(f"CommonsenseClaim dataset saved to '{output_path}' with {len(output_data)} entries.")
