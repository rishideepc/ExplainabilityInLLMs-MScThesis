...
class ProgressAwareMetricsSummarizer:
    def __init__(self, base_path: Optional[str] = None):
        ...
        self.datasets = ["truthfulclaim", "strategyclaim", "medclaim"]  # Focus on problematic dataset for testing
        ...
        self.dataset_name_map = {
            "medqa": "MedClaim",
            "truthfulqa": "TruthfulClaim",
            "strategyqa": "StrategyClaim",
            "commonsenseqa": "CommonSenseClaim"
        }
    ...
    def generate_final_summary(self, summary: Dict):
        ...
        output_csv = os.path.join(output_dir, f"cot_metrics_summary_cv_{timestamp}.csv")
        output_html = os.path.join(output_dir, f"cot_metrics_summary_cv_{timestamp}.html")
...
def example_custom_configuration():
    ...
    summarizer.set_datasets_models(
        datasets=["medclaim", "truthfulclaim", "strategyclaim"],
